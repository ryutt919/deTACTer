...
def load_data():
    full_path = os.path.join(os.path.dirname(os.path.dirname(RAW_DATA_PATH)), os.path.basename(RAW_DATA_PATH))
    # Fallback if relative path issues
    if not os.path.exists(full_path):
         full_path = RAW_DATA_PATH # Try absolute if provided or just use valid path logic
         if not os.path.exists(full_path):
             full_path = "c:/Users/Public/Documents/DIK/deTACTer/" + RAW_DATA_PATH
